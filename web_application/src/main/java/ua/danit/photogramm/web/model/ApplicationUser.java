...
public class ApplicationUser {
  ...
  private ApplicationUser(String nickname, String email, String name, String language) {
   ...
   */
  public static ApplicationUser from(ua.danit.photogramm.users.data.model.User user) {
    if (user == null) {
      return null;
    }
    return new ApplicationUser(user.getNickname(), user.getEmail(), user.getName(), user.getLanguage());
  }
